...
public class AppConfig{
    public final static String URL_Login ="http://10.0.2.2/Cours-Ado/login.php";
    public final static String URL_ListeEleve ="http://10.0.2.2/Cours-Ado/listeEleve.php";
    ...
    public final static String URL_AjoutBilan ="http://10.0.2.2/Cours-Ado/addBilan.php";

    //Pour l'emulation de Genymotion il faut utiliser 10.0.3.2, pour android studio 10.0.2.2

    /*public final static String URL_Login ="http://10.0.3.2/Cours-Ado/login.php";
    public final static String URL_ListeEleve ="http://10.0.3.2/Cours-Ado/listeEleve.php";
    public final static String URL_ListeCours ="http://10.0.3.2/Cours-Ado/listeCours.php";
    ...
    public final static String URL_AjoutBilan ="http://10.0.3.2/Cours-Ado/addBilan.php";*/
